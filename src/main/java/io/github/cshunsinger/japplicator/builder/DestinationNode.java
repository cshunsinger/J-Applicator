...
public class DestinationNode {
     ...
     *
     * @param toVar The index of the local variable containing the current `destination` object (or nested object)
     * @param fromVar The index of the local variable containing a non-null source value.
     * @return The code to set destination object values.
     */
    public CodeInsnBuilderLike buildDestination(Class<?> fromType, int toVar, int fromVar) {
        if(nestedDestinations != null) {
            ...
            CodeInsnBuilderLike convertedSourceValue = SingleValueConverter.createValueConverter(getVar(fromVar), fromType, destType);
